...
- standard_treatments 120개 시술에 영문 slug 추가
- 내부 링크 10개 파일 교체, 한글 URL → slug 301 리다이렉트
- sitemap 영문 slug 기반, GSC/Naver 재제출 완료

이전: v2.10 메인 디자인 개선 (WO-026), v2.9 뷰티회원제 (WO-025)
...
| 날짜 | 내용 |
|------|------|
| 04-17 | WO-025 뷰티회원제, WO-026 메인 디자인, WO-027 slug 전환 완료 |
