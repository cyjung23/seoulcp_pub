...
`https://raw.githubusercontent.com/cyjung23/seoulcp_pub/main/docs/{폴더}/{파일명}`

예시:
https://raw.githubusercontent.com/cyjung23/seoulcp_pub/main/docs/s1-master/s1-01-overview.md
