...
| 2026-04-20 | WO-030 파비콘 SCP 3색 적용 완료, OG이미지 다크 디자인, MON-001 1차 확인 (v2.19) |
...
### 2026-04-20 (v2.19) — 파비콘 교체 + OG이미지 + MON-001
- 파비콘: 동적 생성(icon.tsx) → 정적 SCP 3색 파비콘으로 교체
- 적용 파일 7종: favicon.ico, 16/32px PNG, apple-touch-icon, android-chrome 192/512, webmanifest
- OG이미지: 다크 배경 + SCP 3색 로고 + 태그라인
- layout.tsx: icons + manifest 메타데이터 추가
- 디자인 리포트 v3 완성 (마케팅1팀 협업)
- MON-001 Naver 인덱싱 1차 확인: 전체 6,061개, /ja/ 0개, /zh/ 0개 (제출 후 1일, 정상 대기)
